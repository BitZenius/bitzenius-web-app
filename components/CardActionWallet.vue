    ...
    >
      <template>
        <v-card class="pa-3">
          ...
          <v-card-text v-if="userData" class="mt-3">
            To deposit USDT into your account, transfer the desired amount to
            your Virtual Account Wallet with the following details. The minimum
            transfer amount is $10, and an admin fee of $1 will be applied. For
            instance, if you transfer $100, your balance will be credited with
            $99.
            <div class="mt-5">
              <p>Network<br /><strong>Binance Smart Chain (BEP20)</strong></p>
              <p>
                Address<br /><strong>{{ userData.wallet_va }}</strong>
              </p>
            </div>
