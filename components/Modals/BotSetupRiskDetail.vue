<template>
  <v-card elevation="8">
    <v-card-title class="text-h5 lighten-2"> Detail Risk </v-card-title>
      ...
      <v-stepper elevation="0" class="basic" v-model="e1">
        ...
        <v-stepper-items>
          ...
          <v-stepper-content step="2">
            <v-card elevation="0" class="mb-12 d-flex flex-column align-center">
                  ...
                  >
                    <v-col cols="7" md="7">
                      <v-text-field
                        dense
                        class="mt-2"
                        v-model="applyBalance"
                        label="Total USDT To Apply"
                        outlined
                      ></v-text-field>
                    </v-col>
                    <v-col
              ...
              <v-tooltip right color="success">
                  ...
                  >
                    <v-col cols="7" md="7">
                      <v-text-field
                        ...
                        class="mt-2"
                        v-model="applyBalance"
                        label="Maximum Concurrent Trading Pair"
                        outlined
                      ></v-text-field>
                    </v-col>
                    <v-col
                ...
                <span
                  >Maximum number of concurrent trades the bot is allowed to
                  execute</span
                >
              </v-tooltip>
              <v-row
          ...
          <v-stepper-content step="3">
            <v-card
              class="mb-12 d-flex flex-column align-center"
              flat
              min-height="200px"
            >
              ...
              <v-row style="width: 100%">
                <v-col class="d-flex justify-center" cols="12">
                  <v-btn-toggle
                    ...
                    color="primary"
                  >
                    <v-btn style="width: 50%" value="AND"> AND </v-btn>
                    <v-btn style="width: 50%" value="OR"> OR </v-btn>
                  </v-btn-toggle>
                </v-col>
              </v-row>
              <v-row style="width: 100%">
              ...
              <v-row style="width: 100%">
                <v-col class="d-flex justify-center" cols="12">
                  <v-select
                    :items="['$10,000,000', '$1,000,000', '$100,000']"
