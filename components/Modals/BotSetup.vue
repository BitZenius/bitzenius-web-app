      ...
      <v-row>
        ...
        <v-col cols="6" class="d-flex justify-end">
          <v-btn icon @click="closeModal">
            <v-icon color="basic-text--text">mdi-close</v-icon>
          </v-btn>
        </v-col>
      </v-row>
    </v-card-title>
        ...
        <v-stepper-items>
          <v-stepper-content class="py-0" step="1">
            ...
            <div class="d-flex float-right my-4">
              <v-btn color="primary" @click="_continue(2)"> Continue </v-btn>
            </div>
          </v-stepper-content>
          ...
          <v-stepper-content class="py-0" step="2">
            ...
            <div class="d-flex float-right my-4">
              ...
              <v-btn color="primary" @click="_continue(3)"> Continue </v-btn>
            </div>
          </v-stepper-content>
          ...
          <v-stepper-content class="py-0" step="4">
            <v-card
              class="d-flex flex-column align-center py-8 mt-2"
              flat
              min-height="200px"
            >
              <h3>Summary</h3>
