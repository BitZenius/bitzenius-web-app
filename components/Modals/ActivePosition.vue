...
<v-card elevation="8">
    ...
    <v-card-text class="my-3">
        <v-row class="mx-2">
            <v-scroll-y-transition>
                <v-col style="border-radius:15px; background:#177e89;" class="d-flex align-center justify-center flex-column" cols="12">
                    ...
                    <v-row class="mt-2">
                        <v-col cols="6" md="3">
                            <v-btn style="width:100%;" color="primary" small @click="showDetail = !showDetail">
                        ...
                        <v-col cols="6" md="3">
                            <v-btn style="width:100%;" color="primary" small @click="showStrategy = !showStrategy">
                                <v-icon small class="mr-1">
                        ...
                        <v-col cols="6" md="3">
                            <v-btn style="width:100%;" color="primary" small @click="showFormula = !showFormula">
                                <v-icon small class="mr-1">
        ...
        <v-row>
            <v-col cols="12">
                <v-scroll-y-transition>
                    <v-data-table v-show="showStrategy" :headers="tableTitle" :items="conditionItems" hide-default-header hide-default-footer class="elevation-2 ma-2">
                ...
                <v-scroll-y-transition>
                    <v-data-table v-show="showDetail" :headers="tableDetailTitle" :items="detailItems" hide-default-header hide-default-footer class="elevation-2 ma-2">
                        <template v-slot:item.title="{item}">
                            <span>{{item.title}}</span>
                        </template>
                    </v-data-table>
                ...
                <!-- START OF FORMULA -->
                <v-scroll-y-transition>
                    <div v-show="showFormula" class="pt-0">
        ...
        <v-row v-if="!showFormula">
            <v-col cols="12" md="6">
                <v-btn color="orange white--text" style="width:100%;">PAUSE</v-btn>
            </v-col>
            <v-col cols="12" md="6">
                <v-btn color="danger white--text" style="width:100%;">
                    FORCE SELL
                </v-btn>
            </v-col>
        </v-row>
