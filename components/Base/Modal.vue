          ...
          <v-row justify="center " align="center">
            ...
            <v-col cols="12" md="8">
              ...
              <div class="text-chip font-weight-bold">
                ...
                amount to your <b>Virtual Account Wallet</b> with the following
                information. Minimum transfer amount is <b>$10</b> and
                <b>$1</b> of admin fee will be applied. For example, if you
                transfer $100, so $99 will be added to your balance.
              </div>
            </v-col>
          </v-row>
        </v-card-text>
        <v-card-text v-else class="mt-3">
          You don't have an Virtual Account Wallet. Please contact our customer
