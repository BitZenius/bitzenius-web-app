      ...
      if (val && this.checkMobile()) {
        ...
        var observer = new MutationObserver(function (mutations) {
          mutations.forEach(function (mutationRecord) {
            if (mutationRecord.target.style.bottom != "60px") {
              console.log("styleChanged!", mutationRecord)
              firstIframe.style.setProperty('bottom', '11vh', 'important')
              firstIframe.style.setProperty('right', '10px', 'important')
            }
          });
        ...
        observer.observe(firstIframe, { attributes: true, attributeFilter: ['style'] });
      }
    },
  },
  methods: {
    ...
    initiateTawkTo() {
      ...
      (function () {
        ...
        s1.async = true;
        s1.src = "https://embed.tawk.to/63be8e6ac2f1ac1e202cd9cf/1gmg5okn6";
        s1.charset = "UTF-8";
